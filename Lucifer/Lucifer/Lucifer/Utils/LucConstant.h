...
//  Pods
//
//  Created by wallstreetcn on 14-9-18.
//
//

#ifndef Pods_LucConstant_h
#define Pods_LucConstant_h
...
//新闻接口 v2系列
#pragma mark - 新闻接口 v2系列

//新闻 get
#define kLUC_URLPATH_NEWS @"/v2/posts"

//新闻详细页面 get
#define kLUC_URLPATH_NEWSDETAIL(NID) @"/v2/posts/%@",NID

//实时新闻 get
#define kLUC_URLPATH_LIVENEWS @"/v2/livenews"

//实时新闻详细 get
#define kLUC_URLPATH_LIVENEWSDETAIL(NID) @"/v2/livenews/%@",NID
